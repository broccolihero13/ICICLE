        ...
        $.get('/api/v1/courses/sis_course_id:' + encodeURI(course_sis_source_id))
            .done(function(data) {
                ...
                if (data.sis_import_id !== null) {
                    $('#tab-details>h2:first').after("<em class='remoteAdminTool'>Course Affected by SIS Import <a href='/api/v1/accounts/self/sis_imports/" + data.sis_import_id + "'>" + data.sis_import_id + "</a></em>");
